        ...
        >
          ...
          >
            <div className={`${styles.SelectedRow}`}>
              <b>
                {0 ? <FormattedMessage id="available" defaultMessage="Available" /> : null}Available
              </b>
            </div>
              ...
              {choices
                .filter((choiceItem) => {
                  ...
                  if (searchString === "") {
                    ...
                    return choiceItem.display.toLowerCase().includes(searchString.toLowerCase());
                  }
                })
                .map(({ value, display }, i) => {
                  return (
                    <div
                      ...
                      onMouseDown={(e) => {
                        ...
                        if (selected.filter((item) => item === value).length === 0) {
                          ...
                          valueChanged(selected.filter((e) => e !== value));
                        }
                      }}
                    >
                      {display}
          ...
          >
            <div className={`${styles.SelectedRow}`}>
              <b>
                {0 ? <FormattedMessage id="selected" defaultMessage="Selected" /> : null}Selected
              </b>
            </div>
                  ...
                  return (
                    <div
                      className={`${styles.SelectedRow} ${
                        readOnly ? styles.SelectedRowReadonly : ""
                      }`}
                      style={{
                        display: "flex",
                        justifyContent: "space-between",
                    ...
                    >
                      ...
                      <ClearButton
                        onClick={() => {
                          valueChanged(selected.filter((e) => e !== choiceItem.value));
                        }}
                        styles={{
