...
export const AssetPointSelection: React.FC<MyProps> = (props) => {
  const { value, valueChanged, triedToSubmit, onFocus, onBlur } = props;
      ...
      <div style={{ display: "flex" }}>
        ...
        <div style={{ flex: 2 }}>
          <label className={formStyles.Label}>
            <span className={formStyles.LabelTitle}>Selected asset</span>
            <a
              href={
                value.asset && value.asset.value && value.asset.type
