...
export const MapAssetAndPointSelection = (props: Props) => {
  ...
  if (raster && raster.spatial_bounds) {
    mapLocation = {
      bounds: [
        [raster.spatial_bounds.south, raster.spatial_bounds.west],
        [raster.spatial_bounds.north, raster.spatial_bounds.east],
      ],
    };
  } else {
    mapLocation = {
    ...
    <label htmlFor={name} className={formStyles.Label}>
      ...
      <div className={styles.MapContainer}>
        ...
        >
          ...
          {geometryValidator(value.location) ? <Marker position={marker} /> : null}
        </Map>
      </div>
    </label>
  );
