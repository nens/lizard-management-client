...
const fetchRasterLayers = async (searchQuery: string) => {
  ...
  return response.results.map((raster: RasterLayerFromAPI) =>
    convertToSelectObject(raster.uuid, raster.name, raster.uuid)
  );
};
