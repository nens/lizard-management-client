...
interface SelectDataBoxState {
  showChoices: boolean,
  displayStrings: displayStringsT,
  searchString: string
}

export default class SelectDataBox extends Component<SelectDataBoxProps, SelectDataBoxState> {
  constructor(props: SelectDataBoxProps) {
    super(props);
