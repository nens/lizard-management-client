  ...
  return (
    <div>
      <div className={formStyles.FormGroup + " " + inputStyles.PositionRelative}>
        ...
        >
          <label>Minimal Zoom</label>
          <input
            type="number"
            className={formStyles.FormControl + " " + durationStyles.TextAlignCenter}
            value={value.minZoom}
            onChange={(e) =>
              valueChanged({ minZoom: parseFloat(e.target.value), maxZoom: value.maxZoom })
            }
            ref={minZoomInput}
          />
        </div>
        <div className={durationStyles.DurationInputFields + " " + durationStyles.TextAlignCenter}>
          <label>Maximal zoom</label>
          <input
            type="number"
            className={formStyles.FormControl + " " + durationStyles.TextAlignCenter}
            value={value.maxZoom}
            onChange={(e) =>
              valueChanged({ minZoom: value.minZoom, maxZoom: parseFloat(e.target.value) })
            }
            ref={maxZoomInput}
          />
        </div>
