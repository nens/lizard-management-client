  ...
  return (
    ...
    >
      ...
      >
        <div>
          <p>
            When you change the accessibility of the selected item(s), it will have an impact on who
            can see them. Choose an accessibility here.
          </p>
          <div
            style={{
              display: "flex",
        ...
        <div className={formStyles.ButtonContainer}>
          ...
          <SubmitButton onClick={handleSubmit} readOnly={!accessModifier} />
        </div>
      </div>
    </ModalBackground>
  );
