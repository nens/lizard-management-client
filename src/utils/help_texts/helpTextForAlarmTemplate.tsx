...
export const templateFormHelpText: HelpText = {
  ...
  type: (
    <>
      ...
      <p><em>Add multiple message templates to the Recipients section of an alarm form to send both Email and SMS.</em></p>
  ...
  subject: (
    <>
      ...
      <p><em>This does not apply to SMS messages.</em></p>
    </>
  ),
  message: (
    <>
      <p>Body of the notification message that is sent.</p>
      <p><em>Use variable blocks to enrich the message with contact information and details of the triggered alarm.</em></p>
    </>
  ),
  noFurtherImpactOption: (
    <>
      ...
      <p>Vice versa, if the checkbox is checked, message will be sent when the alarm is withdrawn.</p>
