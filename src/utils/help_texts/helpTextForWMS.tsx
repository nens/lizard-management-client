...
export const wmsFormHelpText: HelpText = {
  ...
  slug: "",
  download_url:
    "Specify which URL is used to download the data. This will enable the download button in the Lizard Catalogue.",
  ...
  get_feature_info_url: (
    <>
      ...
      <p>
        <i>Do not use the GeoWebCache (GWC) URL here.</i>
      </p>
    </>
  ),
  tiled: (
    <>
      ...
      <p>
        <i>
          Enabled by default unless this layer is a "Temporal Raster" and needs to be animated. Only
          for "TMS" and "WMS".
        </i>
      </p>
    </>
  ...
  spatial_bounds: (
    <>
      ...
      <p>
        <i>
          If the source is from a GeoServer, the "Get From GeoServer" button can be used to
