  ...
  return (
    <div>
      <div style={{ marginBottom: "16px" }}>
        Raster Sources are the containers for your raster data. When your raster data is uploaded to
        a Raster Source, it can be published as a Raster Layer to be visualized in the Catalogue and
        the Portal or can be used in a GeoBlocks model.
      </div>
      <div
        style={{
          display: "flex",
      ...
      >
        ...
        <UsagePieChart used={rastersTotalSize} available={rasterAvailableSizeDefinedByContract} />
      </div>
    </div>
  );
};

export const defaultRasterLayerHelpTextTable =
  "Raster Layers are visual presentations of your raster data. Choose the prefered Raster Source so that the Raster Layer fetches the right data and give the Raster Layer a name, description, observation type and styling. Once published, your Raster Layer will be visible in the Catalogue and the Portal.";
...
export const rasterSourceFormHelpText: HelpText = {
  ...
  interval: (
    <>
      ...
      <p>
        <i>
          (e.g. A temporal raster shows data every 5 minutes. The period specified here is the
          interval)
        </i>
      </p>
    </>
  ...
  data: (
    <>
      <p>
        Upload your raster files here in .tif format. For temporal rasters, Lizard will recognize
        the timestamp (in{" "}
        <a href={"https://en.wikipedia.org/wiki/ISO_8601"} target="blank">
          ISO 8601
        </a>{" "}
        format) if it is in the filename.
      </p>
      <p>
        <i>For example: "20210101T1010Z.tif" will be "01-01-2021 10:10:00" in UTC.</i>
      </p>
    </>
  ),
...
export const rasterLayerFormHelpText: HelpText = {
  ...
  description: (
    <>
      ...
      <p>
        <i>
          If this raster was created automatically from a source, there will be a reference to it.
        </i>
      </p>
    </>
  ),
  ...
  rasterSource: (
    <>
      ...
      <p>
        <i>If you come from a source, this will be pre-filled and immutable.</i>
      </p>
    </>
  ),
  aggregationType: (
    <>
      ...
      <p>
        <i>This variable is only used in the "region selection" of the Lizard portal.</i>
      </p>
    </>
  ),
