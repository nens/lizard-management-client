...
export const rasterSourceFormHelpText: HelpText = {
  ...
  data: (
    <>
      <p>Upload your raster files here in .tif format. Lizard will recognize the timestamp (in <a href={"https://en.wikipedia.org/wiki/ISO_8601"} target="blank">ISO 8601</a> format) if it is in the filename. Only UTC time is supported.</p>
