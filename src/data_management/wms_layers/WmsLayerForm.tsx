...
import {
  WmsLayerReceivedFromApi,
  wmsLayerReceivedFromApiToForm,
  WmsLayerFormType,
  wmsLayerGetDefaultFormValues,
  wmsLayerFormToFormSendToApi,
} from "../../types/WmsLayerType";
...
const WmsLayerForm: React.FC<Props & PropsFromDispatch & RouteComponentProps> = (props) => {
  ...
  const initialValues: WmsLayerFormType = currentRecord
    ? wmsLayerReceivedFromApiToForm(currentRecord)
    : wmsLayerGetDefaultFormValues(selectedOrganisation);
    ...
    >
      <form className={formStyles.Form} onSubmit={handleSubmit} onReset={handleReset}>
        ...
        <SelectDropdown
          ...
          placeholder={"- Search and select -"}
          value={
            typeof values.organisation === "string" ? values.organisation : values.organisation
          }
        ...
        <div className={formStyles.ButtonContainer}>
          <CancelButton url={"/management/data_management/wms_layers"} />
          <div style={{ display: "flex" }}>
            {currentRecord ? (
