...
const DeleteLocationNotAllowed = (props: MyProps) => {
  const { name, uuids, closeDialogAction } = props;

  return (
    <Modal title={"Not allowed"} cancelAction={closeDialogAction}>
      <p>
        You are trying to delete the <b>{name}</b> location but this location still has dependent
        time series.
      </p>
