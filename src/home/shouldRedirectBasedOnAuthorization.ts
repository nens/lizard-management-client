...
const shouldRedirectBasedOnAuthorization = function (bootstrap:any, selectedOrganisation:any) {
  ...
  // For example if the user clicks on the tile that has 'linksToUrl: "/data_management/scenarios",' it will see the scenario list, 
  // but currentHomeAppTile is then actually the tile with 'linksToUrl: "/data_management/scenarios",'
