...
class App extends Component {
  ...
  render() {
    ...
    if (currentHomeAppTile && !doArraysHaveEqualElement(((this.props.selectedOrganisation && this.props.selectedOrganisation.roles) || []), currentHomeAppTile.requiresOneOfRoles)) {
