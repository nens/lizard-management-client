...
class App extends Component {
  ...
  render() {
    ...
    // The tile you are currently on (have previously clicked on). Note: the user does not see this tile currently, but sees the screen it lead to.
    // For example if the user clicks on the tile that has 'linksTo: "/data_management/scenarios",' it will see the scenarion list, 
    ...
    console.log("currentHomeAppTile", currentHomeAppTile,  this.props.selectedOrganisation && this.props.selectedOrganisation.roles);
    ...
    console.log("currentHomeAppTile2", currentHomeAppTile.linksTo, currentHomeAppTile,  this.props.selectedOrganisation && this.props.selectedOrganisation.roles);
    ...
    if (
      ...
      this.props.bootstrap && this.props.bootstrap.isAuthenticated &&
      this.props.selectedOrganisation &&
      !doArraysHaveEqualElement(((this.props.selectedOrganisation.roles) || []), (currentHomeAppTile && currentHomeAppTile.requiresOneOfRoles) || ["user", "manager", "supplier", "admin"])
      ) {
